var tokenABI_B = [
  ...
  },
  {
    ...
    'inputs': [{'internalType': 'address', 'name': 'userId', 'type': 'address'}, {
      'internalType': 'uint256',
      'name': 'maxSupply',
      'type': 'uint256'
    ...
    'name': 'royaltyInfo',
    'outputs': [{'internalType': 'address', 'name': '_receiver', 'type': 'address'}, {
      'internalType': 'uint256',
      'name': '_royaltyAmount',
      'type': 'uint256'
    }, {'internalType': 'bytes', 'name': '_royaltyPaymentData', 'type': 'bytes'}],
    'stateMutability': 'view',
    'type': 'function'
  }, {
